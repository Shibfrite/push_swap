...
static int handle_ra_rb(t_dnode **head, t_dnode *current, t_operation *curr_op, t_operation *next_op)
{
	...
	if (!next_op->rotation_count)
		...
		update_node_content(current->next, next_op->name, next_op->rotation_count);
...
static int handle_ra_rra(t_dnode **head, t_dnode *current, t_operation *curr_op, t_operation *next_op)
{
...
static int handle_rb_rrb(t_dnode **head, t_dnode *current, t_operation *curr_op, t_operation *next_op)
{
...
static int handle_rr_rrr(t_dnode **head, t_dnode *current, t_operation *curr_op, t_operation *next_op)
{
